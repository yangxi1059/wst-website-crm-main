  ...
  <d2-container v-loading="loading">
    <div class="d2_container" ref="d2">
      ...
      >
        ...
        <el-table-column prop="beginDate" align="center" label="开始follow时间" min-width="100"></el-table-column>
        <el-table-column prop="endDate" align="center" label="截止follow时间" min-width="100"></el-table-column>
        <el-table-column prop="remark" align="center" label="follow内容" min-width="100"></el-table-column>
        <el-table-column prop="achievement" align="center" label="follow结果" min-width="100"></el-table-column>
...
export default {
  ...
  mounted() {
    api.subordinate(this.userInfo.userId, "sales").then(({ data }) => {
      ...
      if (this.roleInfo.includes(`sales_doed_follow_up_all_data`)) {
  ...
  methods: {
    Topage() {
      ...
      api.getFollowedUpList(params).then(res => {
        this.loading = false
        console.log("follow列表已经follow 销售", res.data);
