 ...
 * @LastEditors: 杨曦
 * @LastEditTime: 2023-03-07 10:40:07
 * @version:
 * @Descripttion:
-->
    ...
    >
      ...
      <div class="create-cant-program-model" v-show="offerPList.programId">
        ...
        >
          ...
          <!-- <el-form-item v-else label="官方价格">
            <span
              :style="{width:widthSpan}"
              class="programName"
            >{{'￥' + (baseProgram.basePriceCny||'无') + '; $' + (baseProgram.basePriceUsd||'无')}}</span>
          </el-form-item> -->
          <!-- <el-form-item label="官方价格(￥)" v-else>
            <el-input-number :style="{width:widthInput}" v-model="baseProgram.basePriceCny" :controls="false" size="mini" :min="0"></el-input-number>
          </el-form-item> -->
...
export default {
  ...
  watch: {
    ...
    discountOfferPrice (v) {
      ...
      cItem.totalPriceUsd = totalPriceUsd.toFixed(1)
      cItem.totalPriceCny = totalPriceCny.toFixed(1)
      ...
      Promise.all(validArr).then(() => {
        if (this.rulesVaildResult.indexOf(false) > -1) {
          ...
          if (this.signOnline) {
            ...
            console.log(supplementaryOffer)
