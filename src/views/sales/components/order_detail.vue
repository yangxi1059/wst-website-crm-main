<template>
  <div class="mentee-detail">
    <el-dialog :close-on-click-modal="false" title="订单详情" :visible.sync="detailVisible" width="1500px" :before-close="close">
      <el-collapse v-model="activeNames">
              ...
              <template v-if="orderInfo.discountInfo">
                ...
                >线上签约</el-col>
                  ...
                  >
                    ...
                    <!-- <div class="copy" :data-clipboard-text="contractURL2">复制URL</div> -->
                    <el-button type="primary" @click="getPayLine(orderInfo.orderId)" size="mini">获取线上支付链接</el-button>
                  </el-col>
              <!-- <el-col
                style="display:inline-block"
                v-if="roleInfo.includes('order_entry') && orderInfo.signStatus == 1 && (orderInfo.payStatus == 2 || orderInfo.payStatus == 0 || orderInfo.payStatus == 3) "
                class="mentee-detail-value"
              >
                <el-button @click="accountEntry(orderInfo.orderId)" size="mini">获取线上支付信息</el-button>
              </el-col> -->
        ...
        <!-- <el-collapse-item name="23" class="mb10">
          <template slot="title">
            <div class="mentee-detail-title">发票信息</div>
            <el-button
              v-if="roleInfo.includes('edit_order_invoice') && !invoiceVisible"
              type="primary"
              size="mini"
              plain
              circle
              @click.stop="setInvoice"
            >{{invoice.invoiceId ? '发票修改' : '新增发票'}}</el-button>
            <el-button
              v-if="roleInfo.includes('edit_order_invoice') && invoiceVisible"
              type="primary"
              size="mini"
              plain
              circle
              @click.stop="submitInvoice"
            >提 交</el-button>
          </template>
          <el-card shadow="hover" v-if="!invoiceVisible">
            <el-card shadow="none" class="mb20" v-if="invoice.invoiceId">
              <el-row>
                <el-col :span="3" class="mentee-detail-name">发票类型</el-col>
                <el-col :span="3" class="mentee-detail-value">{{invoice.invoiceTypeName||'无'}}</el-col>
                <el-col :span="3" class="mentee-detail-name">公司抬头/个人姓名</el-col>
                <el-col :span="3" class="mentee-detail-value">{{invoice.invoiceTitle||'无'}}</el-col>
                <el-col :span="3" class="mentee-detail-name">税号/身份证号</el-col>
                <el-col :span="3" class="mentee-detail-value">{{invoice.invoiceAccount||'无'}}</el-col>
                <el-col :span="3" class="mentee-detail-name">发票地址</el-col>
                <el-col :span="3" class="mentee-detail-value">{{invoice.invoiceAddr||'无'}}</el-col>
                <el-col :span="3" class="mentee-detail-name">发票电话</el-col>
                <el-col :span="3" class="mentee-detail-value">{{invoice.invoicePhone||'无'}}</el-col>
                <el-col :span="3" class="mentee-detail-name">开户行</el-col>
                <el-col :span="3" class="mentee-detail-value">{{invoice.invoiceBank||'无'}}</el-col>
                <el-col :span="3" class="mentee-detail-name">开户行账号</el-col>
                <el-col :span="3" class="mentee-detail-value">{{invoice.invoiceBankAccount||'无'}}</el-col>
                <el-col :span="3" class="mentee-detail-name">是否已经开票</el-col>
                <el-col :span="3" class="mentee-detail-value">{{invoice.invoiceStatusName||'无'}}</el-col>
                <el-col :span="3" class="mentee-detail-name">是否已经寄出</el-col>
                <el-col :span="3" class="mentee-detail-value">{{invoice.isSendName||'无'}}</el-col>
              </el-row>
              <el-row>
                <el-col :span="3" class="mentee-detail-name">收货人名</el-col>
                <el-col :span="3" class="mentee-detail-value">{{invoice.recipientName||'无'}}</el-col>
                <el-col :span="3" class="mentee-detail-name">收货人电话</el-col>
                <el-col :span="3" class="mentee-detail-value">{{invoice.recipientPhone||'无'}}</el-col>
                <el-col :span="3" class="mentee-detail-name">收货人地址</el-col>
                <el-col
                  :span="9"
                  class="mentee-detail-value"
                  :title="invoice.recipientAddr"
                >{{invoice.recipientAddr||'无'}}</el-col>
                <el-col :span="3" class="mentee-detail-name">备注</el-col>
                <el-col
                  :span="9"
                  class="mentee-detail-value"
                  :title="invoice.remark"
                >{{invoice.remark||'无'}}</el-col>
              </el-row>
            </el-card>
            <el-card v-else>暂无发票...</el-card>
          </el-card>
          <el-card shadow="hover" v-else>
            <el-form
              :inline="true"
              ...
              label-width="140px"
            >
              <el-card v-if="invoice" class="mb20">
                ...
                <el-form-item label="税号/身份证号" prop="invoiceAccount">
                  <el-input
                    :style="{width: '230px'}"
                    v-model="invoice.invoiceAccount"
                    :maxlength="100"
                  ></el-input>
                </el-form-item>
                ...
                <el-form-item label="收货人名" prop="recipientName">
                  <el-input :style="{width: '230px'}" v-model="invoice.recipientName"></el-input>
                </el-form-item>
                <el-form-item label="收货人电话" prop="recipientPhone">
                  <el-input :style="{width: '230px'}" v-model="invoice.recipientPhone"></el-input>
                </el-form-item>
                <el-form-item label="收货人地址" prop="recipientAddr">
                  <el-input :style="{width: '610px'}" v-model="invoice.recipientAddr"></el-input>
                </el-form-item>
                <el-form-item label="备注" prop>
                  <el-input :style="{width: '610px'}" v-model="invoice.remark"></el-input>
                </el-form-item>
              </el-card>
            </el-form>
          </el-card>
...
import setInternship from '../../vip/mentee_components/set_internship.vue'
import refund from '../../vip/mentee_components/refund'
import updateSignData from './update_order.vue'
import signUrlSupplementary from '../sign/sign_URL_supplementary'
import { downloadFun } from '@/libs/file'
import mixins from '@/plugin/mixins'
import transtionUpdate from '../../vip/mentee_components/transition.vue'
...
export default {
  ...
  watch: {
    detailVisible: function (val, old) {
      if (val) {
        this.Topage()
        this.pageInit()
      }
  ...
  methods: {
    ...
    getSignUrlByOrderId () {
      ...
      api
        ...
        .then(res => {
          ...
          // this.signUrl = res.data.pageUrl;
          // console.log(this.orderId,this.signUrl, "线上签约路径", res);
          // const btnCopy = new Clipboard(".copy2");
          // console.log(btnCopy);
    ...
    getPayLine (orderId) {
      api.getPayUrl(orderId).then(res => {
        ...
        this.$confirm(`此线上支付地址为 【${this.contractURL2}】`, '提示(已复制到粘贴板)', {
