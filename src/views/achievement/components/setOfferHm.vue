 ...
 * @LastEditors: 杨曦
 * @LastEditTime: 2022-11-21 15:20:40
 * @Version:
 * @Description:
 -->
<template>
      ...
      <div class="set_container">
        <div class="set_list_content">
          <el-descriptions title="" :column="1" :contentStyle="{flex:1}" size="medium">
            ...
            <el-descriptions-item label="学校">{{offerData2.schoolChiName}}</el-descriptions-item>
            <el-descriptions-item label="专业">{{offerData2.majorName}}</el-descriptions-item>
            <el-descriptions-item label="学历">{{offerData2.degreeName}}</el-descriptions-item>
            <el-descriptions-item label="毕业于">{{offerData2.finishYear}}</el-descriptions-item>
        ...
        <div class="set_form_content">
          <el-form :inline="true" label-width="130px" ref="form"  :model="offerData2" :rules="rules">
            ...
            <el-form-item label="官网显示" prop="displayStatus">
              <el-select :style="{width:'160px'}" v-model="offerData2.displayStatus" placeholder="请选择" v-if="roleInfo.includes('vip_offer_hm_list_settingPcWatch')" >
                <el-option
            ...
            <el-form-item label="实习/全职:" prop="resultApply">
                <el-select
                  :style="{width:'160px'}"
                  v-model="offerData2.resultApply"
                  filterable
                  placeholder="请选择"
                >
                  <el-option
            ...
            <el-form-item label="实习类型:" prop="internshipType" v-if="offerData2.resultApply == 0">
                <el-select
                  :style="{width:'160px'}"
                  v-model="offerData2.internshipType"
                  filterable
                  placeholder="请选择"
                >
                  <el-option
            ...
            <el-form-item label="全职类型:" prop="fullTimeType" v-if="offerData2.resultApply == 1">
                <el-select
                  :style="{width:'160px'}"
                  v-model="offerData2.fullTimeType"
                  filterable
                  placeholder="请选择"
                >
                  <el-option
            ...
            <el-form-item label="offer年薪/万(￥):" prop>
              <el-input-number :controls="false" v-model="offerData2.offerSalary" :style="{width:'160px'}" placeholder="求职offer"></el-input-number>
            </el-form-item>
            <el-form-item label="薪资Base:" prop="offerBase">
              <el-input v-model="offerData2.offerBase" :style="{width:'160px'}" placeholder="请输入" :maxlength="20"></el-input>
            </el-form-item>
            <el-form-item label="薪资Bonus:" prop="offerBonus">
              <el-input v-model="offerData2.offerBonus" :style="{width:'160px'}" placeholder="请输入" :maxlength="20"></el-input>
            </el-form-item>
            ...
            <el-form-item label="城市:" prop="city">
              <el-select :style="{width:'160px'}" v-model="offerData2.city" filterable placeholder="请选择">
                <el-option
                  v-for="item in city"
                  :key="item.itemValue"
                  :label="item.itemName"
            ...
            <div v-if="offerData2.mktUsedArticle == '1' || offerData2.mktUsed == '1'">
              ...
              <el-form-item :label="item.confirmCol" v-for="(item,index) in auditorList" :key="index" prop="auditor">
                <el-select
                  :style="{width:'160px'}"
...
export default {
  ...
  watch: {
    settingVisible: function (val) {
      if (val) {
        ...
        console.log(this.offerData2, 'yx************')
  ...
  methods: {
    async pageInit () {
      ...
      apiDic.getAuditorListByApplyType('offer_edit').then(res => {
        res.data.forEach(v => {
          v.auditor = []
    ...
    initPage () {
      ...
      console.log(
        this.offerData2.resultVoucher,
        this.offerData2.resultVoucherMosaic,
        this.offerData2.offerVoucher,
        this.offerData2.offerVoucherMosaic,
        ...
        const subData =
          {
            ...
            internshipType: this.offerData2.resultApply == '0' ? this.offerData2.internshipType : '',
            fullTimeType: this.offerData2.resultApply == '1' ? this.offerData2.fullTimeType : '',
            offerSalary: this.offerData2.offerSalary,
            offerBase: this.offerData2.offerBase,
            offerBonus: this.offerData2.offerBonus,
            ...
            offerFrom: this.offerData2.offerFrom,
    ...
    submitMKT () {
      ...
      let data = {}
      data = {
        applyType: 'offer_edit',
        applyTitle: `学员${this.offerData2.menteeName}的求职offer修改`,
        approval: approval,
        ...
        content: {
          ...
          text: [
            ...
            {
              label: '学历',
              value: this.offerData2.degreeName
            },
            {
              label: '毕业于',
              value: this.offerData2.finishYear
            },
            {
              label: 'sales已用',
          ...
          info: {
            ...
            displayStatus: this.offerData2.displayStatus,
            resultApply: this.offerData2.resultApply,
            internshipType: this.offerData2.internshipType,
            fullTimeType: this.offerData2.fullTimeType,
            programPeriod: this.offerData2.programPeriod,
            offerSalary: this.offerData2.offerSalary,
            offerBase: this.offerData2.offerBase,
            offerBonus: this.offerData2.offerBonus,
      ...
      if (this.offerData2.checkStatus == this.offerData.checkStatus) {
        ...
        const vb = this.checkStatusS.filter((v) => v.itemValue == this.offerData.checkStatus)[0]
        updateList.push({
          label: '审核（修改前）',
      ...
      if (this.offerData2.displayStatus == this.offerData.displayStatus) {
        ...
        const vb = this.displayStatusS.filter((v) => v.itemValue == this.offerData.displayStatus)[0]
        updateList.push({
          label: '官网显示（修改前）',
          value: vb ? vb.itemName : ''
        })
      ...
      if (this.offerData2.resultApply == this.offerData.resultApply) {
        updateList.push({
          label: '实习/全职',
          value: this.internship_or_full_time.filter((v) => v.itemValue == this.offerData2.resultApply)[0].itemName
        })
      } else {
        const vb = this.internship_or_full_time.filter((v) => v.itemValue == this.offerData.resultApply)[0]
        updateList.push({
          label: '实习/全职（修改前）',
          value: vb ? vb.itemName : ''
        })
      ...
      if (this.offerData2.resultApply == 0) {
        if (this.offerData2.internshipType == this.offerData.internshipType) {
          updateList.push({
            label: '实习类型',
            value: this.internship_type.filter((v) => v.itemValue == this.offerData2.internshipType)[0].itemName
          })
        } else {
          const vb = this.internship_type.filter((v) => v.itemValue == this.offerData.internshipType)[0]
          updateList.push({
            label: '实习类型（修改前）',
            value: vb ? vb.itemName : ''
          })
      ...
      if (this.offerData2.resultApply == 1) {
        if (this.offerData2.fullTimeType == this.offerData.fullTimeType) {
          updateList.push({
            label: '全职类型',
            value: this.full_time_type.filter((v) => v.itemValue == this.offerData2.fullTimeType)[0].itemName
          })
        } else {
          const vb = this.full_time_type.filter((v) => v.itemValue == this.offerData.fullTimeType)[0]
          updateList.push({
            label: '全职类型（修改前）',
            value: vb ? vb.itemName : ''
          })
      ...
      if (this.offerData2.offerSalary == this.offerData.offerSalary) {
        updateList.push({
          label: 'offer年薪/万(￥)',
          value: this.offerData2.offerSalary
        })
      } else {
        updateList.push({
          label: 'offer年薪/万(￥)（修改前）',
          value: this.offerData.offerSalary
        })
        updateList.push({
          label: 'offer年薪/万(￥)（修改后）',
          value: this.offerData2.offerSalary
      ...
      if (this.offerData2.offerBase == this.offerData.offerBase) {
        updateList.push({
          label: '薪资Base',
          value: this.offerData2.offerBase
        })
      } else {
        updateList.push({
          label: '薪资Base（修改前）',
          value: this.offerData.offerBase
        })
        updateList.push({
          label: '薪资Base（修改后）',
          value: this.offerData2.offerBase
      ...
      if (this.offerData2.offerBonus == this.offerData.offerBonus) {
        updateList.push({
          label: '薪资Bonu',
          value: this.offerData2.offerBonus
        })
      } else {
        updateList.push({
          label: '薪资Bonu（修改前）',
          value: this.offerData.offerBonus
        })
        updateList.push({
          label: '薪资Bonu（修改后）',
          value: this.offerData2.offerBonus
      ...
      if (this.offerData2.shield == this.offerData.shield) {
        ...
        const vb = this.common_yes_or_no.filter((v) => v.itemValue == this.offerData.shield)[0]
        updateList.push({
          label: '屏蔽学生学校（修改前）',
          value: vb ? vb.itemName : ''
        })
      ...
      if (this.offerData2.publicStatus == this.offerData.publicStatus) {
        ...
        const vb = this.common_yes_or_no.filter((v) => v.itemValue == this.offerData.publicStatus)[0]
        updateList.push({
          label: '可宣传（修改前）',
          value: vb ? vb.itemName : ''
        })
      ...
      if (this.offerData2.company == this.offerData.company) {
        updateList.push({
          label: '公司',
          value: this.company.filter((v) => v.companyId == this.offerData2.company)[0].companyName
        })
      } else {
        const vb = this.company.filter((v) => v.companyId == this.offerData.company)[0]
        updateList.push({
          label: '公司（修改前）',
          value: vb ? vb.companyName : ''
        })
        updateList.push({
          label: '公司（修改后）',
          value: this.company.filter((v) => v.companyId == this.offerData2.company)[0].companyName
      ...
      if (this.offerData2.division == this.offerData.division) {
        updateList.push({
          label: '部门',
          value: this.division.filter((v) => v.itemValue == this.offerData2.division)[0].itemName
        })
      } else {
        const vb = this.division.filter((v) => v.itemValue == this.offerData.division)[0]
        updateList.push({
          label: '部门（修改前）',
          value: vb ? vb.itemName : ''
        })
      ...
      if (this.offerData2.city == this.offerData.city) {
        updateList.push({
          label: '城市',
          value: this.city.filter((v) => v.itemValue == this.offerData2.city)[0].itemName
        })
      } else {
        const vb = this.city.filter((v) => v.itemValue == this.offerData.city)[0]
        updateList.push({
          label: '城市（修改前）',
          value: vb ? vb.itemName : ''
        })
      ...
      if (this.offerData2.applySeason == this.offerData.applySeason) {
        ...
        const vb = this.apply_season.filter((v) => v.itemValue == this.offerData.applySeason)[0]
        updateList.push({
          label: '申请季（修改前）',
          value: vb ? vb.itemName : ''
        })
      ...
      if (this.offerData2.offerFrom == this.offerData.offerFrom) {
        updateList.push({
          label: 'Offer类型',
          value: this.offer_from.filter((v) => v.itemValue == this.offerData2.offerFrom)[0].itemName
        })
      } else {
        const vb = this.offer_from.filter((v) => v.itemValue == this.offerData.offerFrom)[0]
        updateList.push({
          label: 'Offer类型（修改前）',
          value: vb ? vb.itemName : ''
        })
      ...
      if (this.offerData2.community == this.offerData.community) {
        updateList.push({
          label: '社团',
          value: this.offerData2.community
        })
      } else {
        updateList.push({
          label: '社团（修改前）',
          value: this.offerData.community
        })
        updateList.push({
          label: '社团（修改后）',
          value: this.offerData2.community
