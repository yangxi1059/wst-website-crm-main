  ...
  <d2-container v-loading="loading">
    ...
    >
      ...
      <el-table-column align="center" label="操作" width="100">
        <template slot-scope="scope">
          <el-button type="text" size="mini" @click="setPraise(scope.row)">设置</el-button>
        </template>
      </el-table-column>
      ...
      <el-table-column prop="praiseVoucher" label="好评图(无码)">
        <template slot-scope="scope">
          <el-button
            ...
            @click="preview(scope.row.praiseVoucher,'mentee_praise_view_nm')"
          >查看</el-button>
          <el-button
            size="mini"
            type="text"
            v-if="scope.row.praiseVoucher"
            @click="download(scope.row.praiseVoucher,'mentee_praise_view_nm')"
          >下载</el-button>
        </template>
      </el-table-column>
      <el-table-column prop="praiseVoucher" label="好评图(有码)">
        <template slot-scope="scope">
          <el-button
            ...
            @click="preview(scope.row.praiseVoucherMosaic,'mentee_praise_view_hm')"
          >查看</el-button>
          <el-button
            size="mini"
            type="text"
            v-if="scope.row.praiseVoucherMosaic"
            @click="download(scope.row.praiseVoucherMosaic,'mentee_praise_view_hm')"
          >下载</el-button>
        </template>
      </el-table-column>
    </el-table>
    <SetPraise :settingVisible="settingVisible" :praiseObjData="praiseObjData" @close="setPraiseClose" @submit="setPraiseSubmit" ></SetPraise>
  </d2-container>
</template>
