...
<template>
  <div>
    ...
    >
      ...
      >
        <el-table-column min-width="150px" align="center" prop="realName" label="一对多课程名">
...
import detail from './detailOneToOne.vue'

export default {
  name: 'common-detail',
  components: { detail },
  props: {
    oneTooneDetailVisible: Boolean,
    day: String,
    userId: String
  },
  data: () => {
  ...
  watch: {
    oneTooneDetailVisible: function (v) {
      if (v) {
        this.initPage()
      }
    }
  ...
  methods: {
    ...
    initPage () {
      ...
      api.getOneTooneLessonsList(params).then(res => {
