<!--
 * @Author: 杨曦
 * @Date: 2023-01-11 16:13:29
 * @LastEditors: 杨曦
 * @LastEditTime: 2023-01-11 16:17:10
 * @Version: 
 * @Description: 
-->
<!--
...
<template>
  <div>
    <el-dialog :close-on-click-modal="false" title="Jerry一对多课程详情" :visible.sync="detailVisible" width="900px" :before-close="close">
...
import auditOneToOne from './successJerryOneToOne.vue'
