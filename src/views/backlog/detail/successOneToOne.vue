...
<template>
  <div>
    <el-dialog :close-on-click-modal="false" title="已完成一对多课时申请" :visible.sync="auditOneToOneVisible" width="900px" :before-close="close">
...
export default {
  ...
  methods: {
    ...
    submit () {
      ...
      const data = {
        applyType: 'vip_office_hour_lesson',
        keyId: this.mentorData.lessonId,
        applyTitle: `导师【${this.mentorData.lessonMentorName}】的一对多课程申请`,
        approval: approval,
        copyTo: [],
        content: {
          file: [],
