 ...
 * @LastEditors: 杨曦
 * @LastEditTime: 2022-02-11 14:03:47
 * @Version: 1
 * @Description:
 -->
 <template>
  <div class="mentor-price-rule-edit">
    <el-dialog title="规则详情" :close-on-click-modal="false" :visible.sync="editVisible" width="1200px" :before-close="close">
      <div class="search_page">
        <div class="search">
          <el-form :inline="true" label-width="150px" :rules="rules" size="mini" :model="submitData" ref="tableValidate">
            <el-form-item>
      ...
      <el-table :data="tableData" size="mini" highlight-current-row :max-height="height">
