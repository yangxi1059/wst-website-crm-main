<template>
  ...
  <div class="mentor-commisson-apply">
    <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
      <el-tab-pane v-if="roleInfo.includes('mentor_pay_cashier_pay')" label="待支付" name="first">
        ...
        >
          ...
          <el-table-column align="center" label="操作" width="180">
            <template slot-scope="scope">
             <el-dropdown  v-if="scope.row.canPayStatus == '1'" split-button  @click="toPay(scope.row)">
                支付
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item ><div @click="detail(scope.row)">旧版支付</div></el-dropdown-item>
                </el-dropdown-menu>
              </el-dropdown>
        ...
        >
          ...
          <el-table-column sortable="custom" prop="payAccName" align="center" label="支付宝姓名" min-width="100"></el-table-column>
          <el-table-column sortable="custom" prop="usdFee" align="center" label="美金合计" min-width="100"></el-table-column>
          <el-table-column sortable="custom" prop="cnyFee" align="center" label="人民币合计" min-width="100"></el-table-column>
          <el-table-column
            sortable="custom"
      ...
      <el-tab-pane v-if="roleInfo.includes('mentor_pay_cashier_check')" label="支付记录" name="second">
        <div class="search_page">
          <div class="search">
            ...
            <el-button  class="mr10" size="mini"  @click="uploadPath">导出付款凭证</el-button>
            <el-button
              icon="el-icon-search"
              class="mr10"
              size="mini"
    ...
    />
    <mentorPayListNew
      :mentorPayListNewVisible="mentorPayListNewVisible"
      :payData="payData"
      @close="mentorPayListNewClose"
      @submit="mentorPayListNewSubmit"
    />
    <mentorPaymentExtra
...
import mentorPayList from '../../apply_audit/mentor_pay/pay_list.vue'
import mentorPayListNew from '../../apply_audit/mentor_pay/pay_list_new.vue'
import mentorPaymentExtra from '../../apply_audit/mentor_payment_extra/cashier.vue'
...
export default {
  ...
  methods: {
    ...
    Topage () {
      ...
      console.log(this.pageType, this.paymentType)
      if (this.pageType) {
    ...
    toPay (v) {
      ...
      if (!this.pageType) {
        ...
        this.mentorPayListNewVisible = true
        v.showDetail = false
      }
      this.payData = v
    },
    ...
    mentorPayListNewClose () {
      this.mentorPayListNewVisible = false
    },
    mentorPayListSubmit () {
      this.Topage(1)
      this.mentorPayListClose()
    },
    mentorPayListNewSubmit () {
      this.Topage(1)
      this.mentorPayListNewClose()
    },
    sortTable (v) {
