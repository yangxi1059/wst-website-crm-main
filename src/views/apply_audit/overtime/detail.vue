<template>
  <div class="mentor-pay">
    <el-dialog :close-on-click-modal="false"
      :title="'请假申请'"
      :visible.sync="overtimeDetailVisible"
      width="1000px"
...
export default {
  ...
  watch: {
    overtimeDetailVisible: function (newData, oldData) {
      if (newData) {
        ...
        api.getApplyDetailByApplyId(this.applyData.applyId).then(res => {
          ...
          this.account = ''
          this.account = this.refundData.content.info.overtimeReason
          console.log(this.account, this.refundData.content.info.payAccount)
          this.totalRefund = ''
          this.totalRefund =
            this.refundData.content.info.overtimeTotalWage
          this.approval = ''
