    ...
    >
            ...
            <el-col :span="20" class="_item-value">
              <div class="mb10" v-for="(item,i) in refundData.content.file" :key="i">
                ...
                <el-button
                  ...
                  size="mini"
                  v-if="roleInfo.includes('bd_audit_bd_expenditure_download')"
                  title="下载"
                  type="text"
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <template v-if="canSubmit && refundData.apply.applyStatus == 1">
          <el-button type="primary" @click="applyList">申请列表</el-button>
...
import applyList from '../../BD/components/activity_apply_list.vue'
...
export default {
  ...
  methods: {
    ...
    applyList () {
      console.log(this.refundData.content.info.activityId)
      this.activityData = {
        activityId: this.refundData.content.info.activityId
      }
