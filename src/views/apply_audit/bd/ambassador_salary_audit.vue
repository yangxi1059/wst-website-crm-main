            ...
            <el-col :span="16" class="_item-value">
              <div class="mb10" v-for="(item,i) in refundData.content.file" :key="i">
                ...
                <el-button
                  ...
                  size="mini"
                  title="下载"
                  v-if="roleInfo.includes('school_audit_contract_download')"
                  type="text"
...
import applyList from '@/views/BD/ambassador/apply_list'
...
export default {
  ...
  methods: {
    ...
    applyList () {
      ...
      this.ambassadorData = {
        ambassadorId: this.refundData.content.info.ambassadorId
      }
