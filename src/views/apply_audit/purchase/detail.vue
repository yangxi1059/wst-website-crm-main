<template>
  <div class="mentor-pay">
    ...
    >
      ...
      <!-- <el-row class="mb10">
        <el-col :span="4" class="_item-name">采购事由</el-col>
...
export default {
  ...
  watch: {
    purchaseDetailVisible: function (newData, oldData) {
      if (newData) {
        ...
        api.getApplyDetailByApplyId(this.applyData.applyId).then(res => {
          ...
          this.account = ''
          this.account = this.refundData.content.info.purchaseReason
          console.log(this.account, this.refundData.content.info.payAccount)
          this.totalRefund = ''
          this.totalRefund =
            this.refundData.content.info.purchaseTotalWage
          this.approval = ''
