 ...
 * @LastEditors: 杨曦
 * @LastEditTime: 2022-02-24 15:42:30
 * @Version:
 * @Description:
 -->
<template>
  <div class="mentor-pay">
    ...
    >
      ...
      <!-- <el-row class="mb10">
        <el-col :span="4" class="_item-name">系统汇率</el-col>
  ...
  methods: {
    Topage () {
      api.getApplyDetailByApplyId(this.applyData.applyId).then(res => {
        console.log('详情数据yx123123132', res)
        this.refundData = {
          pay: res.data.pay,
        ...
        // });
        if (
          this.refundData.content.info.exchangeRate !== 'exchangeRateReplace'
        ) {
