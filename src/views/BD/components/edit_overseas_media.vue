<template>
  <div class="hr-user-edit">
    ...
    v-loading="loading"
      :title="cacheCooperatorData.cooperatorId ? '编辑合作商':'新增媒体投放合作商'"
    ...
    >
      ...
      >
        ...
        <el-form-item label="媒体/公众号名称" prop="officialAccountName">
          <el-input
            :style="{width:widths}"
            v-model="cacheCooperatorData.officialAccountName"
            :maxlength="99"
          ></el-input>
        </el-form-item>
        <el-form-item label="媒体/公众号ID" prop="officialAccountId">
          <el-input
            :style="{width:widths}"
            v-model="cacheCooperatorData.officialAccountId"
            :maxlength="99"
          ></el-input>
        </el-form-item>

        <el-form-item label="媒体/公众号类型" prop="officialAccountType">
          <el-input
            :style="{width:widths}"
            v-model="cacheCooperatorData.officialAccountType"
            :maxlength="99"
          ></el-input>
        </el-form-item>

        <el-form-item label="媒体/公众号粉丝数" prop="officialAccountFansNum">
          <el-input-number
            :controls="false"
            :style="{width:widths}"
            v-model="cacheCooperatorData.officialAccountFansNum"
          ></el-input-number>
        </el-form-item>

        <el-form-item label="针对国家/地区" prop="countryId">
          <el-select
            :style="{width:widths}"
            filterable
        ...
        <el-form-item label="公众号头条平均阅读量" prop="officialAccountAverageReading">
          <el-input-number
            :controls="false"
            :style="{width:widths}"
        ...
        <el-form-item label="头条单位阅读量价格(￥)" prop="averageReadingPrice">
          <el-input-number
            :controls="false"
            :style="{width:widths}"
         ...
         <el-form-item label="公众号次条平均阅读量" prop="officialAccountSecondAverageReading">
          <el-input-number
            :controls="false"
            :style="{width:widths}"
            v-model="cacheCooperatorData.officialAccountSecondAverageReading"
            maxlength="99"
          ></el-input-number>
        </el-form-item>
        <el-form-item label="次条单位阅读量价格(￥)" prop="secondAverageReadingPrice">
          <el-input-number
            :controls="false"
            :style="{width:widths}"
            v-model="cacheCooperatorData.secondAverageReadingPrice"
            maxlength="99"
          ></el-input-number>
        </el-form-item>

        <el-form-item label="详细报价" prop="communicateFeedback">
          <el-input
            :style="{width:widths}"
            type="textarea"
        ...
        <el-form-item label="公众号+人物画像简介" prop="cooperatorIntroduction">
          <el-input
            :style="{width:widths}"
            type="textarea"
  ...
  data () {
    return {
      ...
      rules: {
        ...
        cooperatorStatus: [{ required: true, message: '必填', trigger: 'blur' }],
        officialAccountType: [{ required: true, message: '必填', trigger: 'blur' }],
        officialAccountFansNum: [{ required: true, message: '必填', trigger: 'blur' }],
        officialAccountName: [{ required: true, message: '必填', trigger: 'blur' }],
        officialAccountSecondAverageReading: [{ required: true, message: '必填', trigger: 'blur' }],
        secondAverageReadingPrice: [{ required: true, message: '必填', trigger: 'blur' }],
        officialAccountId: [{ required: true, message: '必填', trigger: 'blur' }],
