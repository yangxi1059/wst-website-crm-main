 ...
 * @LastEditors: 杨曦
 * @LastEditTime: 2022-03-14 15:41:35
 * @Version:
 * @Description:
-->
<template>
    <div>
        <el-dialog :close-on-click-modal="false" title="无效咨询列表" :visible.sync="consultingTableVisible" width="1400px" :before-close="close">
            ...
            <el-table
                ...
                <el-table-column label="核验状态" width="80">
                    <template slot-scope="scope">
                        <span v-if="scope.row.checkStatus == '0'">未核验</span>
                        <span v-else>已核验</span>
                    </template>
                </el-table-column>
                <el-table-column label="学员名" prop="menteeName" width="100"></el-table-column>
                ...
                <el-table-column  label="家长微信一" prop="parentWx1"></el-table-column>
                <el-table-column  label="家长微信二" prop="parentWx2"></el-table-column>
                <el-table-column  label="发起人" prop="createByName"></el-table-column>
                <el-table-column  label="助理名" prop="assistantName"></el-table-column>
...
export default {
  ...
  watch: {
    consultingTableVisible: function (val) {
      if (val) {
        this.checkStatus = '0'
        this.initPage()
      }
