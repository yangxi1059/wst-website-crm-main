...
export function export_json_to_excel(multiHeader = [], multiHeader2 = [],multiHeader3 = [], header, jsonData, defaultTitle, merges = [],XLSX) {
  console.log(XLSX)
  /* original data */
  ...
  var wb = new Workbook(), ws = sheet_from_array_of_arrays(data,XLSX);
