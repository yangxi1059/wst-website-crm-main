    ...
    <div class="sales yx-echarts">
      <div class="search_page">
        <div class="search">
          ...
          <el-button @click="addItem()" size="mini">新增</el-button>
      ...
      <div class="table mt10" v-if="'mentor_payment' == applyType">
        <hot-table
      ...
      <div class="table mt10" v-else-if="'internship_offer_payment' == applyType">
        <hot-table
      ...
      <add-money-out :addVisible="addVisible" @close="addClose" @submit="addSubmit" />
      <el-dialog
        :title="'金额汇总'"
...
import addMoneyOut from './components/add_money_out.vue'
...
export default {
  name: 'money-out',
  mixins: [mixins],
  components: { 'add-money-out': addMoneyOut },
  created () {},
  mounted () {
    this.pageInit()
