  ...
  <d2-container v-loading="loading">
    <div class="dictionary">
        ...
        <div class="search">
            <el-input
            class="mr10"
            v-if="roleInfo.includes(`graduate_search`)"
            size="mini"
            v-model="search"
            clearable
            placeholder="支持项目名"
            ...
            <el-button
            icon="el-icon-plus"
            v-if="roleInfo.includes(`graduate_new`)"
            size="mini"
            plain
            @click="newdic"
            >新增</el-button>
            ...
            >公共模板设置</el-button>
            <el-button
            v-if="roleInfo.includes(`graduate_sort`)"
            size="mini"
            type="primary"
            @click="sortTableBtn"
            >排序</el-button>
        ...
        <pagination
            v-if="roleInfo.includes(`graduate_page`)"
            :total="total"
        ...
        <el-table-column align="center" label="详情"  width="200px">
            ...
            <el-button
                type="text"
                size="mini"
                v-if="roleInfo.includes(`graduate_edit`)"
            ...
            <el-button
                type="text"
                size="mini"
                v-if="roleInfo.includes(`graduate_pic`)"
                @click="toImg(scope.row.programId)"
                class="el-icon-picture-outline"
            >图片</el-button>
            <el-button
                type="text"
                v-if="roleInfo.includes(`graduate_del`)"
                size="mini"
        ...
        <el-table-column align="center" prop="gpBackgroundPromotionQuantity" label="背景提升数量"></el-table-column>
        <el-table-column align="center" prop="gpBackgroundPromotionPriceCny" label="背景提升人民币价格"></el-table-column>
        <el-table-column align="center" prop="gpBackgroundPromotionPriceUsd" label="背景提升美金价格"></el-table-column>
        <el-table-column align="center" prop="gpMajorQuantity" label="专业大类数量"></el-table-column>
        <el-table-column align="center" prop="gpProgramApplyQuantity" label="项目申请数量"></el-table-column>
        ...
        <el-dialog title="申研项目内容" :visible.sync="visible" width="1050px" :before-close="clone">
        <el-form
            :model="ruleForm"
            :rules="rules"
            size="medium"
        ...
        >
            ...
            <el-form-item label="一对多Offer Hour：" prop="officeHourStrategistSession">
...
import detailProgram from '../continual/components/detail_program_graduate.vue'
import sortTable from '../continual/components/sortTable.vue'
import imgUpload from '../continual/components/img_upload.vue'
import commonTemplate from '../basic/components/common_template.vue'
import { mapState } from 'vuex'

export default {
  components: { detailProgram, sortTable, imgUpload, commonTemplate },
  mixins: [mixins],
  computed: {
    ...mapState('role', [
      'roleInfo'
  ...
  methods: {
    initPage () {
      api.getProgramDic('graduate_program').then((res) => {
    ...
    newdic () {
      this.ruleForm.programType = 'graduate_program'
      this.visible = true
    },
    commonSet () {
