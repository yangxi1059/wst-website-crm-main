 ...
 * @LastEditors: 杨曦
 * @LastEditTime: 2022-02-23 10:05:05
 * @Version: 1
 * @Description:
 -->
<template>
  <d2-container v-loading="loading">
    <div class="dictionary">
        ...
        <div class="search">
            <el-input
            class="mr10"
            v-if="roleInfo.includes(`suspend_search`)"
            size="mini"
            style="width:150px"
            v-model="search"
            clearable
            ...
            icon="el-icon-plus"
            class=""
            v-if="roleInfo.includes(`suspend_new`)"
            size="mini"
            plain
            @click="newdic"
            >新增</el-button>
            <el-button
            v-if="roleInfo.includes(`suspend_sort`)"
            class=""
            size="mini"
            type="primary"
            @click="sortTableBtn"
        ...
        <pagination
            v-if="roleInfo.includes(`suspend_page`)"
            :total="total"
        ...
        <el-table :data="tableData" size="mini" highlight-current-row >
            <el-table-column align="center" label="详情" width="200px">
                ...
                <el-button
                    type="text"
                    size="mini"
                    v-if="roleInfo.includes(`suspend_edit`)"
                ...
                <el-button
                    type="text"
                    size="mini"
                    v-if="roleInfo.includes(`suspend_pic`)"
                    @click="toImg(scope.row.programId)"
                    class="el-icon-picture-outline"
                >图片</el-button>
                <el-button
                    type="text"
                    v-if="roleInfo.includes(`suspend_del`)"
                    size="mini"
...
export default {
  ...
  methods: {
    initPage () {
      api.getProgramDic('suspend').then((res) => {
    ...
    newdic () {
      this.ruleForm.programType = 'suspend'
      this.programId = ''
