 ...
 * @LastEditors: 杨曦
 * @LastEditTime: 2022-02-16 11:45:48
 * @Version: 1
 * @Description:
 -->
<template>
  <d2-container v-loading="loading">
    <div class="dictionary">
        ...
        <div class="search">
            <el-input
            class="mr10"
            v-if="roleInfo.includes(`extension_search`)"
            size="mini"
            style="width:150px"
            v-model="search"
            clearable
            ...
            icon="el-icon-plus"
            class=""
            v-if="roleInfo.includes(`extension_new`)"
            size="mini"
            plain
            @click="newdic"
            >新增</el-button>
            <el-button
            v-if="roleInfo.includes(`extension_sort`)"
            class=""
            size="mini"
            type="primary"
            @click="sortTableBtn"
        ...
        <pagination
            v-if="roleInfo.includes(`extension_page`)"
            :total="total"
        ...
        <el-table-column align="center" label="详情" width="200px">
            ...
            <el-button
                type="text"
                size="mini"
                v-if="roleInfo.includes(`extension_edit`)"
            ...
            <el-button
                type="text"
                size="mini"
                v-if="roleInfo.includes(`extension_pic`)"
                @click="toImg(scope.row.programId)"
                class="el-icon-picture-outline"
            >图片</el-button>
            <el-button
                type="text"
                v-if="roleInfo.includes(`extension_del`)"
                size="mini"
...
export default {
  ...
  methods: {
    initPage () {
      api.getProgramDic('extension').then((res) => {
    ...
    newdic () {
      this.ruleForm.programType = 'extension'
      this.programId = ''
