    ...
    >
     <div style="padding-left:20px">
      <el-row class="mb10">
        ...
        <div v-if="ruleForm.programType != 'jcxy' && ruleForm.programType !='oral'  && ruleForm.programType !='finance' ">
        ...
        <div v-if="ruleForm.programType =='finance' ">
          <el-col :span="4" class="_item-name">财商导师一对一：</el-col>
          <el-col
            :span="8"
            class="_item-value"
          >{{ruleForm.financeHour == -1 ? '不限' : ruleForm.financeHour}}</el-col>
        </div>
        <div v-if="ruleForm.programType =='oral' ">
          <el-col :span="4" class="_item-name">口语导师一对一：</el-col>
          <el-col
            :span="8"
            class="_item-value"
          >{{ruleForm.oralLessonHour == -1 ? '不限' : ruleForm.oralLessonHour}}</el-col>
        </div>
        ...
        <el-col :span="4" class="_item-name" v-if="ruleForm.programType == 'finance'">财商课时：</el-col>
        <el-col :span="8" class="_item-value" v-if="ruleForm.programType == 'finance'">{{ruleForm.financeHour}}</el-col>
        <el-col :span="4" class="_item-name">线下课：</el-col>
        <el-col :span="8" class="_item-value">{{ruleForm.hasSeminars || '无'}}</el-col>
        ...
        <el-col :span="8" class="_item-value">
          <span >{{ruleForm.programWeight}}</span>
        </el-col>
        <el-col :span="4" class="_item-name" v-if="ruleForm.programType =='finance'">固定提成比例(%):</el-col>
        <el-col :span="8" class="_item-value" v-if="ruleForm.programType =='finance'">
...
export default {
  components: { inputNumber, setContract, editProgram, detailContractProgram, followUpRule },
  mixins: [mixins],
  props: {
    detailVisible: {
      type: Boolean,
  ...
  methods: {
    ...
    Topage () {
      ...
      this.$loading()
      // let b = api.getTemplateList(this.programId).then((res) => {
      //   console.log(res);
