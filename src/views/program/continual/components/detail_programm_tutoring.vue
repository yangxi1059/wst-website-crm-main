    ...
    >
      <div style="padding-left:20px">
        <el-row class="mb10">
          ...
          <el-col :span="4" class="_item-name">课业辅导一对一：</el-col>
          <el-col
            :span="8"
            class="_item-value"
          >{{ruleForm.tutoringMentorHour == -1 ? '不限' : ruleForm.tutoringMentorHour}}</el-col>
          ...
          <el-col :span="8" class="_item-value" style="white-space:pre-wrap;">{{ruleForm.programDetail || ''}}</el-col>
...
import editProgram from './edit_programm_tutoring.vue'
...
export default {
  ...
  methods: {
    init () {
      api.getDicDropdown('program_type').then((res) => {
    ...
    viewContract (contractContent, contractTitle) {
      const submitData = {
        ...
        tutoringSubjectList: this.ruleForm.tutoringSubject,
