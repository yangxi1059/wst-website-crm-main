 ...
 * @LastEditors: 杨曦
 * @LastEditTime: 2022-02-16 11:29:24
 * @Version: 1
 * @Description:
 -->
<template>
  <d2-container v-loading="loading">
    <div class="dictionary">
        ...
        <pagination
            v-if="roleInfo.includes(`internship_program_page`)"
            :total="total"
        ...
        <el-table-column align="center" label="详情" width="120px">
            ...
            <el-button
                type="text"
                size="mini"
                v-if="roleInfo.includes(`internship_program_edit`)"
            ...
            <el-button
                type="text"
                size="mini"
                v-if="roleInfo.includes(`internship_program_pic`)"
...
export default {
  components: { detailProgram, sortTable, imgUpload },
  mixins: [mixins],
  computed: {
    ...mapState('role', [
      'roleInfo'
  ...
  methods: {
    initPage () {
      api.getProgramDic('internship').then((res) => {
    ...
    newdic () {
      this.ruleForm.programType = 'internship'
      this.programId = ''
