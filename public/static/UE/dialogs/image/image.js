    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            uploader = _this.uploader = WebUploader.create({
                ...
                server: 'https://bucket-wst-website-dev.oss-cn-shanghai.aliyuncs.com',
            ...
            uploader.on('uploadBeforeSend', function (file, data, header) {
                console.log(file,data,header);
            // expire 过期才去获取下面的信息
                $.ajax({
                    type : "GET",
                    url : "https://www.pageguo.com/wb-api-test/system/ossStsToken",
                timeout : 10000,
                dataType:"JSON",
                headers:{
                    'xxx':'',
                ...
                success : function(obj2) {
                    ...
                    data = $.extend(data,{
                                'key' : obj2.dir + '${filename}',//这里最好在后台处理好
                                'policy': obj2.policy,
                                'OSSAccessKeyId': obj2.accessKeyId,
